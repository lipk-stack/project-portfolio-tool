...
export function buildPortfolioPdf(portfolioId: number | null): PDFKit.PDFDocument | null {
  ...
  doc.fontSize(9).text(`Generated ${new Date().toISOString().slice(0, 10)} · ProjectPulse`, doc.page.width - 220, 32, { width: 172, align: 'right' })
  ...
  doc.fill('#9CA3AF').font('Helvetica').fontSize(8)
    .text('Generated by ProjectPulse — Enterprise Portfolio Management', 48, doc.page.height - 60, { width: pageWidth, align: 'center' })
