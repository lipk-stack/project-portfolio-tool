...
const TRIGGER_TYPES = ['task_created', 'task_status_changed', 'task_assigned', 'risk_created', 'risk_updated', 'project_health_red', 'project_health_improved', 'task_overdue', 'budget_overrun', 'milestone_missed']
